...
function draw_game_board()
  ...
  -- Bottom-right
  gfx.line(BOARD_X + BOARD_PX_W + 2 - cl, BOARD_Y + BOARD_PX_H + 2, BOARD_X + BOARD_PX_W + 2, BOARD_Y + BOARD_PX_H + 2, HOLO)
  gfx.line(BOARD_X + BOARD_PX_W + 2, BOARD_Y + BOARD_PX_H + 2 - cl, BOARD_X + BOARD_PX_W + 2, BOARD_Y + BOARD_PX_H + 2, HOLO)
end
